...
export default function ChatInterface() {
  ...
  const wrapper = { display: 'flex', flexDirection: 'column', height: '100vh', maxWidth: '600px', margin: '0 auto', border: '1px solid #ddd', borderRadius: '8px', overflow: 'hidden', backgroundColor: '#fff' };
  ...
  const buttonStyle = { padding: '0.75rem 1.5rem', backgroundColor: '#0070f3', color: '#fff', border: 'none', borderRadius: '9999px', cursor: 'pointer' };
  ...
  return (
    <div style={wrapper}>
      ...
      <div style={inputContainer}>
        ...
        />
        <button style={buttonStyle} onClick={sendMessage}>Envoyer</button>
      </div>
    </div>
  );
}